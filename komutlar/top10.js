...
if(client.guilds.size<10)returnmessage.reply("Bot`10`tanesunucudabulunmuyor!")

consttop=client.guilds.sort((a,b)=>a.memberCount-b.memberCount).array().reverse()
...
name:'top10',
category:'genel',
description:'Botunbulunduğusunuculardanençokkişiyesahipolan10sunucuyusıralar.',
usage:'top10'
};