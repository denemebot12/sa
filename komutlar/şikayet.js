...
const errors = require("../ayarlar/hatavar1.js");
...
exports.run = function(client, message, args) {
    ...
    .setDescription("Yeni Şikayet Var MAMDİN SERİ BAK")
    .setColor(orange)
    ...
    let reportschannel = message.guild.channels.find(`name`, "şikayet-log");
    if(!reportschannel) return message.channel.send(" `şikayet-log` İsminde Yazı Kanalı Bulamıyorum.!");
